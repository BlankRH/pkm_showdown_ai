...
LADDER_URL = "http://pokemonshowdown.com/ladder/gen7ou"
...
def parse_args():
    ...
    argparser.add_argument('--end_index', default=50, type=int)
    argparser.add_argument('--max_page', default=2, type=int)
...
if __name__ == "__main__":
    ...
    for user in usernames[args.start_index:args.end_index]:
        ...
        for i in range(1, args.max_page + 1):
            ...
            if len(replay_ids) == 0 or page_done(r, replay_ids):
